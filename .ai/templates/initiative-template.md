...
Define new or changed domain concepts. Do not assume future agents know what the terms mean.
...
Describe how data moves between frontend, backend, shared contracts, storage, and external systems.
