...
- Do not make shared/tagged memories look like visit proof.
...
- Add marker detail drawer/page/read surface for own proof posts and allowed memories once backend supports them.
- Ensure the UI does not imply shared memories are proof.
...
- Marker detail does not expose shared/tagged memories for locked sites.
