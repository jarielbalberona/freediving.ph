...
- Latest execution status: `12-instructor-application-profile-parity.md` passed on 2026-06-01. Mobile now supports authenticated instructor profile/application editing, certification list/create/edit/delete, certification proof upload, submit attestation, backend verification status display, public instructor route, instructor deep links, targeted tests, mobile type-check/lint, and successful iOS Simulator smoke on iPhone 17 Pro Max with the running Expo/Metro session.
