...
export const appUsersRelations = relations(appUsers, ({ many, one }) => ({
  permissionOverride: one(userPermissionOverrides, {
    fields: [appUsers.id],
    references: [userPermissionOverrides.userId]
  }),
  groupMemberships: many(groupMemberships),
  eventMemberships: many(eventMemberships)
}));

export const groupMembershipsRelations = relations(groupMemberships, ({ one }) => ({
  user: one(appUsers, { fields: [groupMemberships.userId], references: [appUsers.id] }),
...
export const eventMembershipsRelations = relations(eventMemberships, ({ one }) => ({
  user: one(appUsers, { fields: [eventMemberships.userId], references: [appUsers.id] }),
