...
test("resolves confirmed Freediving Philippines URLs to native mobile routes", () => {
  ...
  assertNative(
    "https://freediving.ph/instructor/profile",
    "/(app)/(tabs)/(home)/instructor-application",
  );
  assertNative(
    "https://freediving.ph/instructor/certifications",
    "/(app)/(tabs)/(home)/instructor-application",
  );
  assertNative(
  ...
  assertNative(
    "https://freediving.ph/guides/freediving-safety-basics",
    "/(app)/(tabs)/(home)/learn",
  );
  assertNative(
...
test("notification action URLs use the shared native resolver safely", () => {
  ...
  assert.equal(
    notificationHrefFromActionUrl("/schools"),
    "/(app)/(tabs)/(home)/schools",
  );
  assert.equal(
    notificationHrefFromActionUrl("/my/bookings"),
    "/(app)/(tabs)/(home)/schools/bookings",
  );
  assert.equal(
    notificationHrefFromActionUrl("/instructor/profile"),
    "/(app)/(tabs)/(home)/instructor-application",
  );
  assert.equal(
    notificationHrefFromActionUrl("/instructors/jariel"),
    "/(app)/(tabs)/(home)/instructors/jariel",
  );
  assert.equal(
    notificationHrefFromActionUrl("/saved"),
    "/(app)/(tabs)/(home)/saved",
  );
  assert.equal(notificationHrefFromActionUrl("/search"), "/(app)/(tabs)/search");
  assert.equal(notificationHrefFromActionUrl("/profile"), "/(app)/(tabs)/profile");
  assert.equal(
    notificationHrefFromActionUrl("/profile/settings"),
    "/(app)/(tabs)/profile/settings",
  );
