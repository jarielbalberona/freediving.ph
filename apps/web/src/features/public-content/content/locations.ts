...
export const locationPages: PublicLocationContent[] = [
  {
    ...
    metaTitle: "Freediving in the Philippines | Spots, Schools, Guides and Community",
    metaDescription:
      "Plan freediving in the Philippines with destination guides, community-approved dive spot notes, nearby schools, events, buddies, and safety-focused beginner resources.",
    intro:
      "Use this hub to plan safer, realistic Philippines sessions: compare destinations, connect with schools or buddies, check community dive spots, and choose what to do next based on current local conditions.",
    highlights: [
      "The Philippines has island and coastal options for beginners, travelers, and regular training plans, but every area has different access, weather, and seasonal behavior.",
      "Comparing destinations first and then narrowing by schools, buddy support, and community activity leads to safer planning than guessing in advance.",
      "Community guidance and guides on this site help you move from broad ideas to practical next steps.",
    ],
    bestFor: [
      "Beginners choosing where to start and who to dive with",
      "Travelers planning island trips with realistic safety buffers",
      "Local freedivers comparing weekend opportunities around Manila and nearby provinces",
      "Schools and organizers sharing a clear entry path for newcomers",
    ],
    safetyNotes: [
      "Never freedive alone. A trained buddy and a clear safety plan are required, no matter how familiar the area feels.",
      "Conditions change by day: tide, wind, current, swell, visibility, and boat traffic can all affect whether a session is appropriate.",
      "Respect marine protected areas, local rules, operator guidance, and school instructions before finalizing a plan.",
    ],
    gettingStartedTips: [
      "Choose your destination by intent: learning, weekend trip, community dive, or marine-life-focused visit.",
      "If you are new, start with a guided intro before planning deeper sessions.",
      "Use Explore to check community-recommended spots, then confirm local conditions before entering the water.",
      "Use safety and gear guides before confirming a date, then add a buddy or school to your plan.",
    ],
    relatedGuideSlugs: [
  ...
  },
  {
    ...
    nearbyLocationSlugs: ["dauin", "apo-island", "panglao", "cebu", "philippines"],
    exploreQuery: {
  ...
  },
  {
    ...
    nearbyLocationSlugs: ["moalboal", "panglao", "siquijor", "apo-island", "philippines"],
    exploreQuery: {
      locationSlug: "cebu",
      province: "Cebu",
      aliases: ["Cebu"],
  ...
  },
  {
    ...
    nearbyLocationSlugs: ["apo-island", "siquijor", "cebu", "panglao", "philippines"],
    exploreQuery: {
      locationSlug: "dauin",
  ...
  },
  {
    ...
    nearbyLocationSlugs: ["dauin", "siquijor", "panglao", "cebu", "philippines"],
    exploreQuery: {
  ...
  },
  {
    ...
    nearbyLocationSlugs: ["siquijor", "cebu", "apo-island", "dauin", "philippines"],
    exploreQuery: {
  ...
  },
  {
    ...
    nearbyLocationSlugs: ["cebu", "panglao", "siquijor", "apo-island", "philippines"],
    exploreQuery: {
