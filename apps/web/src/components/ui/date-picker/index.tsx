    ...
    <Popover
      ...
      onOpenChange={(next) => {
        ...
        if (
          ...
          anchorRef.current?.contains(closeTargetRef.current as Node)
        ) {
          closeTargetRef.current = null;
          return;
        }
    ...
    >
        ...
        <PopoverTrigger
          render={
            <button
              ...
              className="absolute left-1.5 top-1/2 opacity-0"
              disabled={disabled}
            />
          }
        />
      ...
      >
        <Calendar
          ...
          disabled={[
            ...(effectiveMin ? [{ before: effectiveMin }] : []),
            ...(effectiveMax ? [{ after: effectiveMax }] : []),
          ]}
