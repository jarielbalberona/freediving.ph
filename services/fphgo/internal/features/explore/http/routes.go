...
func Routes(h *Handlers) chi.Router {
	...
	r.Group(func(member chi.Router) {
		...
		member.Group(func(submissions chi.Router) {
			...
			submissions.Get("/sites/edit-proposals", h.ListMySiteEditProposals)
			submissions.Get("/sites/edit-proposals/{id}", h.GetMySiteEditProposalByID)
			submissions.Post("/sites/{slug}/edit-proposals", h.CreateSiteEditProposal)
		...
		member.Group(func(moderation chi.Router) {
			...
			moderation.Get("/moderation/site-edits/pending", h.ListPendingSiteEditProposals)
			moderation.Get("/moderation/site-edits/{id}", h.GetSiteEditProposalForModeration)
			moderation.Post("/moderation/site-edits/{id}/approve", h.ApplySiteEditProposal)
			moderation.Post("/moderation/site-edits/{id}/reject", h.RejectSiteEditProposal)
		})
	})
